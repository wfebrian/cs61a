...
;;; Note: tests from CS61A Scheme Project page are also included

;;; q4
'q4
;expect q4
;;; q4 tests from CS61A Scheme Project page
+
; expect #[primitive]
(+ 1 2)
; expect 3
...
'q5
; expect q5
;;; q5 tests from CS61A Scheme Project page
(define x 15)
; expect x
(define y (* 2 x))
; expect y
...
'q6
; expect q6
;;; q6 tests from CS61A Scheme Project page
'hello
; expect hello
'(1 . 2)
; expect (1 . 2)
...
'q7
; expect q7
;;; q7 tests from CS61A Scheme Project page
(begin (+ 2 3) (+ 5 6))
; expect 11
...
(begin (* 9 7) (/ 8 4))
; expect 2
(begin (/ 1 0) (car '(1994 1997)))
; Error:
(begin (/ 0 1) (car '(1994 1997)))
; expect 1994

;;; q8
'q8
; expect q8
;;; q8 tests from CS61A Scheme Project page
(lambda (x y) (+ x y))
...
; expect Error:
(lambda (x y z) (* x y))
; expect (lambda (x y z) (* x y))
(lambda (x y z) (/ x y z))
; expect (lambda (x y z) (/ x y z))
(lambda (many) (1) (2) (3))
; expect (lambda (many) (begin (1) (2) (3)))

;;; q9
'q9
; expect q9
;;; q9 tests from CS61A Scheme Project page
...
'q13
; expect q13
;;; q13 tests from CS61A Scheme Project page
(if (= 4 2) true false)
; expect #f
(if (= 4 4) (* 1 2) (+ 3 4))
; expect 2
...
'q14
; expect q14
;;; q14 tests from CS61A Scheme Project page
(and)
; expect #t
(or)
; expect #f
...
'q15
; expect q15
;;; q15 tests from CS61A Scheme Project page
(cond ((= 4 3) 'nope)
      ((= 4 4) 'hi)
      (else 'wait))
; expect hi
...
'q16
; expect q16
;;; q16 tests from CS61A Scheme Project page
(define x 'hi)
; expect x
(define y 'bye)
; expect y
...
'q17
; expect q17
;;; q17 tests from CS61A Scheme Project page
(define f (mu (x) (+ x y)))
; expect f
